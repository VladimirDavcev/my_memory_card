...
questions_list = []
questions_list.append(Question('The state language of Brazil', 'Portuguese', 'Spanish', 'Italian', 'Brazillian'))
questions_list.append(Question('Which colour does not appear on the American flag?', 'Green', 'Red', 'White', 'Blue'))
questions_list.append(Question('A tradiotional residence of Yakut people', 'Urasa', 'Yurt', 'Igloo', 'Hut'))
